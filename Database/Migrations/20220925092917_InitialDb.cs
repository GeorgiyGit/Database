    ...
    public partial class InitialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LikeUsersId = table.Column<int>(type: "int", nullable: false),
                    LikedCommentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentUser", x => new { x.LikeUsersId, x.LikedCommentsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DislikeUsersId = table.Column<int>(type: "int", nullable: false),
                    DislikedCommentsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentUser1", x => new { x.DislikeUsersId, x.DislikedCommentsId });
                    table.ForeignKey(
